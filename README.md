...
-   The `abc2midi` executable must be compiled on your host OS. To compile the executable with make and cd to the top directory (`musical_python/`) and run `(cd abcmidi && make && mv ./abc2midi ../ && cd ..)`
