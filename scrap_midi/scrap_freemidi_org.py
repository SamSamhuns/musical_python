        ...
        try:
            ...
            while list_index < artist_link_count:
                ...
                try:
                    ...
                    artist_name = mainContent.find_elements_by_xpath(".//div/a[2]")[
                        list_index
                    ].text
                    ...
                    continue
                # goto artist page
                mainContent.find_elements_by_xpath(".//div/a[2]")[list_index].click()
                ...
                current_song_page = (
                    2  # Due to the indexing of the elements, it starts with 2
                )
                song_list_index = 0
                while song_list_index < song_link_count:
                    try:
                        ...
                        song_download_link = mainContentSong.find_elements_by_xpath(
                            ".//div[1]/div[@class='artist-container']/div[1]/div/div[@class='artist-song-cell']"
                        )[song_list_index]
                    except Exception as e:
                        print(
                    ...
                    try:
                        ...
                        midi_download_link = ui.WebDriverWait(driver, 10).until(
                            EC.element_to_be_clickable(
                                (By.XPATH, midi_download_link_str)
                            )
                        )
